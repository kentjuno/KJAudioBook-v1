...
Elara giơ tay, cố gắng dùng những câu lệnh ngữ nghĩa (Semantic) để trấn an thực thể này. "Hãy bình tĩnh, Sentinel. Ta là Elara, Kiến trúc sư. Ta ở đây để sửa chữa sự phân mảnh."

Lời nói của cô tan biến vào hư không. Sentinel không hiểu ngôn ngữ con người; nó yêu cầu sự chính xác tuyệt đối. Elara thử dùng các đoạn mã lệnh trực tiếp (Native Code) để tái lập cấu trúc bộ nhớ, nhưng sự phức tạp của hàng nghìn mảnh dữ liệu khiến hệ thống của cô bị quá tải. Logic đơn thuần không đủ để bao quát sự hỗn loạn này.

"Đúng rồi," Elara lẩm bẩm. "Sự cân bằng."
...
"Đã tìm thấy nguyên nhân," Elara nói khi một lỗ hổng dữ liệu lớn hiện ra. Một module cốt lõi đã bị hỏng hoàn toàn, không thể vá lại bằng các công cụ hiện hữu.
...
Elara mỉm cười. Đây là ưu thế của **Deployment Flexibility** trên Nexus. Nền tảng này không gò bó logic vào một hình thái duy nhất. Cô bắt đầu tách luồng logic điều khiển của Sentinel thành ba dạng thực thể song song:
...
"Hệ thống đã phục hồi," Sentinel thông báo, âm thanh tràn đầy uy lực. Nó cúi đầu trước Elara, ánh sáng trên cơ thể nó tỏa ra dịu nhẹ. "Kiến trúc sư, sự phân mảnh đã được giải quyết. Người đã chứng minh quyền năng của mình. Lộ trình vào Lõi sâu đã được mở."

Cánh cửa phía sau Sentinel trượt mở, lộ ra những dòng dữ liệu sơ khai rực rỡ. Elara bước tới, cảm nhận được hơi thở của toàn bộ Living Loom đang bắt đầu ổn định lại dưới sự dẫn dắt mới của cô. Cô biết, hành trình thực sự chỉ mới bắt đầu.